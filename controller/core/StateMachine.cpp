...
common::DeviceState StateMachine::getCurrentState() const {
    return currentState_;
}

bool StateMachine::canHandleCommand(const std::string& command) const {
...
bool StateMachine::transitionTo(common::DeviceState nextState) {
    switch (currentState_) {
    case common::DeviceState::INIT:
...
bool StateMachine::applyCommand(const std::string& command) {
